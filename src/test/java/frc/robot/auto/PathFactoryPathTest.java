...
public class PathFactoryPathTest {
  private void pathTest(
      List<AutoPaths.CoralMovement> expected, int index, AutoPaths.PlanConstraints constraints) {
    ...
    pathTest(
        List.of(
            new AutoPaths.CoralMovement(
                new AutoPaths.CoralPosition(4, 2), AutoPaths.CoralSource.PREPLACED),
            new AutoPaths.CoralMovement(
                new AutoPaths.CoralPosition(6, 3), AutoPaths.CoralSource.STATION_LEFT)),
        0,
  ...
  public void pathTest2() {
    pathTest(
        List.of(
            new AutoPaths.CoralMovement(
                new AutoPaths.CoralPosition(6, 3), AutoPaths.CoralSource.PREPLACED),
            new AutoPaths.CoralMovement(
                new AutoPaths.CoralPosition(4, 2), AutoPaths.CoralSource.STATION_RIGHT)),
        1,
        new AutoPaths.PlanConstraints(
            List.of(new AutoPaths.CoralPosition(4, 2), new AutoPaths.CoralPosition(6, 3)),
  ...
  public void pathTest3() {
    pathTest(
        List.of(),
        0,
        new AutoPaths.PlanConstraints(List.of(), new AutoPaths.CoralSources(true, true, true)));
  }
