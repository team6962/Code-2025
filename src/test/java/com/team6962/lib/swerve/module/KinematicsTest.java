...
public class KinematicsTest {
    ...
    public void allianceToRobotSpeeds() {
        ...
        ChassisSpeeds orginalSpeeds = new ChassisSpeeds(
            MetersPerSecond.of(1.0),
            MetersPerSecond.of(2.0),
            RotationsPerSecond.of(0.3)
        );

        assertEquals(coordinates.robotToAllianceSpeeds(coordinates.allianceToRobotSpeeds(orginalSpeeds)), orginalSpeeds);
    }
}
