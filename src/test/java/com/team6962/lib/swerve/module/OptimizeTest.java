...
public class OptimizeTest {
  private void testOptimization(
      SwerveModuleState state, Angle start, SwerveModuleState expectedOutput) {
  ...
  public void optimizeTestInvertSpeed() {
    testOptimization(
        new SwerveModuleState(1, Rotation2d.fromDegrees(0)),
        Degrees.of(120),
        new SwerveModuleState(-1, Rotation2d.fromDegrees(180)));
  }

  @Test
  public void optimizeTestInvertExtraTarget() {
    testOptimization(
        new SwerveModuleState(1, Rotation2d.fromDegrees(360)),
        Degrees.of(120),
        new SwerveModuleState(-1, Rotation2d.fromDegrees(180)));
  }
  ...
  public void optimizeTestExtraMeasure() {
    testOptimization(
        new SwerveModuleState(1, Rotation2d.fromDegrees(360)),
        Degrees.of(720 - 10),
        new SwerveModuleState(1, Rotation2d.fromDegrees(720)));
  }
  ...
  public void optimizeTestInvertExtraMeasure() {
    testOptimization(
        new SwerveModuleState(1, Rotation2d.fromDegrees(360)),
        Degrees.of(720 + 120),
        new SwerveModuleState(-1, Rotation2d.fromDegrees(720 + 180)));
  }

  @Test
  public void optimizeTestHigherSpeed() {
    testOptimization(
        new SwerveModuleState(14.3, Rotation2d.fromDegrees(360)),
        Degrees.of(720 - 10),
        new SwerveModuleState(14.3, Rotation2d.fromDegrees(720)));
  }
}
