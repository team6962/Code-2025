...
public class PositionController implements AutoCloseable {
  ...
  public PositionController(
      TrapezoidProfile.Constraints profileConstraints, PIDConstraints pidConstraints) {
  ...
  public double calculateVelocity(
    ...
    finished = /*Math.abs(target.position - end.position) < tolerance && */
        motionProfile.isFinished(time);
