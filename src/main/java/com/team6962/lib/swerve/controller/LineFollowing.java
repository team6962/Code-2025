...
public final class LineFollowing {
  ...
  public static Vector2 fieldToPathPosition(
      Vector2 robotPositionFieldCoords, Vector2 start, Vector2 pathDirection) {
    return fieldToPathDisplacement(robotPositionFieldCoords.minus(start), pathDirection);
  }

  public static Vector2 pathToFieldPosition(
      Vector2 robotPositionPathCoords, Vector2 start, Vector2 pathDirection) {
    return start.plus(pathToFieldDisplacement(start, pathDirection));
  }

  public static Vector2 fieldToPathDisplacement(
      Vector2 robotDisplacementFieldCoords, Vector2 pathDirection) {
  ...
  public static Vector2 pathToFieldDisplacement(
      Vector2 robotDisplacementPathCoords, Vector2 pathDirection) {
    Vector2 pathNormal = pathDirection.rotate90CCW();

    return pathDirection
        .times(robotDisplacementPathCoords.x)
        .plus(pathNormal.times(robotDisplacementPathCoords.y));
  }
}
