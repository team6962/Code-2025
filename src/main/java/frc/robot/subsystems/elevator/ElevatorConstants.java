...
public final class ElevatorConstants {
  ...
  public static final double SENSOR_MECHANISM_RATIO =
      MOTOR_GEAR_REDUCTION / SPOOL_DIAMETER.times(Math.PI).in(Meters);

  public static final int LEFT_MOTOR_ID = 5;
  public static final int RIGHT_MOTOR_ID = 4;

  public static final InvertedValue LEFT_MOTOR_INVERTED_VALUE =
      InvertedValue.CounterClockwise_Positive;
  public static final InvertedValue RIGHT_MOTOR_INVERTED_VALUE = InvertedValue.Clockwise_Positive;

  public static final SlotConfigs emptySlot =
      new SlotConfigs()
          .withKP(6)
          .withKI(0.3)
          .withKD(1)
  ...
  public static final SlotConfigs coralSlot =
      new SlotConfigs()
          .withKP(6)
          .withKI(0.3)
          .withKD(1)
          ...
          .withGravityType(GravityTypeValue.Elevator_Static)
          .withStaticFeedforwardSign(StaticFeedforwardSignValue.UseVelocitySign);
  public static final SlotConfigs algaeSlot =
      new SlotConfigs()
          .withKP(6)
          .withKI(0.3)
          .withKD(1)
  ...
  public static final CurrentLimitsConfigs currentLimitsConfigs =
      new CurrentLimitsConfigs().withSupplyCurrentLimit(90).withSupplyCurrentLimitEnable(true);
