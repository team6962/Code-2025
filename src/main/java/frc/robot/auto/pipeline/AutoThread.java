...
public class AutoThread extends Thread {
    ...
    public void setParameters(AutoPaths.PlanParameters parameters) {
        ...
        // if (this.parameters != null) System.out.println("Matches: " + this.parameters.matches(parameters));
    ...
    public Command getCommand(BooleanSupplier shouldContinueComputing) {
        ...
        Logger.log(AutoPaths.Logging.AUTO_THREAD + "/command/hasCommandBuilder", commandBuilder != null);
