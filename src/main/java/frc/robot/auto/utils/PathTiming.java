...
public final class PathTiming {
  ...
  public static Time getPathTime(
      List<AutoPaths.CoralMovement> path, Pose2d startPose, double timeBias) {
  ...
  public static Pair<Time, Pose2d> getMovementResult(
      AutoPaths.CoralMovement movement, Pose2d startPose) {
