...
public final class AutoPaths {
  ...
  public static class CoralSources {
    ...
    @Override
    public boolean equals(Object obj) {
      return obj instanceof CoralSources
          && ((CoralSources) obj).preplaced == preplaced
          && ((CoralSources) obj).leftStation == leftStation
          && ((CoralSources) obj).rightStation == rightStation;
    }
  }
  ...
  public static class PlanParameters {
    ...
    public static PlanParameters fromAutoChooser(boolean preplaced, Pose2d startPose) {
      CoralSources sources =
          new CoralSources(
              preplaced, AutonChooser.leftCoralStation(), AutonChooser.rightCoralStation());
  ...
  public static class CoralMovement {
    ...
    @Override
    public boolean equals(Object obj) {
      return obj instanceof CoralMovement
          && ((CoralMovement) obj).destination.equals(destination)
          && ((CoralMovement) obj).source == source;
    }
  }
