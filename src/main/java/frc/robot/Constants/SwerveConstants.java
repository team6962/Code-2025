...
public final class SwerveConstants {
    ...
    private static Chassis getChassis(ChassisType chassisType) {
        return switch (chassisType) {
            case COMPETITION -> new Chassis(Inches.of(30), Inches.of(30), Inches.of(24.75), Inches.of(24.75), Pounds.of(135));
            case TEST -> new Chassis(Inches.of(28), Inches.of(28), Inches.of(22.75), Inches.of(22.75), Pounds.of(50));
        };
    }

    private static enum ChassisType { COMPETITION, TEST }
