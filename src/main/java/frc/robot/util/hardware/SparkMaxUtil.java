...
public final class SparkMaxUtil {
  public static void configureAndLog(SubsystemBase subsystem, SparkMax motor, SparkMaxConfig config, boolean inverted, IdleMode idleMode) {
    configureAndLog(subsystem, motor, config, inverted, idleMode, NEO.SAFE_FREE_CURRENT, NEO.SAFE_STALL_CURRENT);
  }

  public static void configureAndLog(SubsystemBase subsystem, SparkMax motor, SparkMaxConfig config, boolean inverted, IdleMode idleMode, int freeCurrentLimit, int stallCurrentLimit) {
  ...
  public static void configureAndLog550(SubsystemBase subsystem, SparkMax motor, SparkMaxConfig config, boolean inverted, IdleMode idleMode) {
    configureAndLog(subsystem, motor, config, inverted, idleMode, 10, 40);
  }
  ...
  public static void configurePID(SubsystemBase subsystem, SparkMaxConfig config, double kP, double kI, double kD, double kV, boolean wrap) {
  ...
  public static void save(SparkMax motor, SparkMaxConfig config) {
